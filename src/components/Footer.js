...
const Footer = () => {
  return (
    <footer class="bg-accentBorderInverseSecondary section">
      <div class="m-auto px-6 py-6 md:px-10 lg:px-16 xl:px-20 2xl:px-40">
        <svg
          role="img"
        ...
        <div class="mt-6 flex flex-col gap-y-8 md:flex-row md:gap-16">
          <div class="flex-shrink flex-grow basis-1/6">
            <p class="font-normal leading-body m-0 p-0 text-left text-textPrimary text-base">
            ...
            <ul class="mt-6 space-y-4">
              <li class="mt-4">
                ...
                <p class="font-normal leading-body m-0 p-0 text-left text-textPrimary text-sm mt-3">
