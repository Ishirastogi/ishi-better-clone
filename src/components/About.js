            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="rounded-sm relative w-full bg-accentSecondary my-lg p-base lg:p-xl ml-8 translate-x-1/2 lg:ml-3xl">
                <p className="font-normal leading-body m-0 p-0 text-left text-textSecondary text-base">
                  ...
                  <a
                    className="rounded-base leading-body text-base text-center font-bold select-none outline-none transition duration-300 ease-universal focus:shadow-[0_0_0_4px_inset] disabled:text-interactiveForegroundMuted disabled:bg-interactiveMuted disabled:shadow-none text-interactiveForegroundPrimary bg-interactivePrimary hover:bg-accentPrimary focus:bg-accentPrimary focus:shadow-accentBorderPrimary active:bg-accentPrimary px-base h-2xl items-center justify-center mt-4 flex w-fit"
                    href="/start"
                  >
                    Get started
                  </a>
